...
<div class="login">
    <Row justify="center" align="middle" @keydown.enter.native="submitRegist" style="height:100%">
        <div class="loginUp">
            <div class="loginLeft">
                <img src="../assets/login/logo.png" alt="" srcset=""  style="height: 76px;order-bottom-width: 0px;">
...
.login {
    ...
    .login-btn{
        width: 390px;
        height: 50px;
        background: radial-gradient(circle, #82bdfc, #82bdfc);
        border: 2px solid #82bdfc;
